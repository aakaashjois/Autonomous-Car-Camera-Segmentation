...
from SegmentationFCN import SegmentationFCN
import numpy as np
...
class SegmentationAgent:
    def __init__(self, num_data, train_num, val_num, num_classes,
        ...
        train_split, val_split, test_split = self.make_splits(
            train_num, val_num, shuffle_data)
        ...
        self.model = SegmentationFCN(self.num_classes, self.device)
    ...
    def make_splits(self, train_split, val_split, shuffle=True):
        if shuffle:
        ...
        validation_masks = self.masks_list[train_split:train_split + val_split]

        test_images = self.images_list[train_split + val_split:]
        test_masks = self.masks_list[train_split + val_split:]
